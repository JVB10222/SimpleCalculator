...
{
    /*PRIVATE RECTANGLE - 
     *  this is a piece of code already made by mcsft to allow objects to be wrapped like in Word
     *  so that you are able to resize them by implementing other code.
     *  
     *  OTHER CODE TO SIZE DOWN BELOW
         */
    public partial class CalculatorV1 : Form
    {
        ...
        /*NEW RECTANGLE = basically it gives the location of the object so that any reactive code that 
         * has been implemented can continue to work in the new space that it has been allowed
         * 
         */
        private void CalculatorV1_Load(object sender, EventArgs e)
        {
            ...
            squareButtonOriginalRectangle = new Rectangle(squareRootButton.Location.X, squareRootButton.Location.Y, squareRootButton.Width, squareRootButton.Height);
        ...
        private void CalculatorV1_Resize(object sender, EventArgs e)
        {
            ...
            resizeControl(squareButtonOriginalRectangle, squareRootButton);
        ...
        private void CalculatorV1_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.NumPad1:
        ...
        private void CalculatorV1_KeyUp(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Enter:
